...
const Header = () => {
  return (
    // START HEADER
    <div className="container mt-11 mx-auto my-0 bg-yellow-100 rounded-[30px]">
      <div className="bg-muted p-8 rounded-lg flex flex-col lg:flex-row items-center justify-between">
        <div className="lg:w-1/2">
          ...
          <h1 className="md:text-[64px] text-4xl font-bold text-foreground md:leading-[60px] mb-4 lg:text-2xl1 py-5 my-10">
            Simplify Easy Banking at your confort
          </h1>
          <p className="text-muted-foreground text-[18px] leading-8 mb-6">
            We connect all banks to seamlessly transact between them or other
            account, monitor transactions history in one place while tracking
            and monitoring expenses which allow spending management and
            planning.
          </p>
